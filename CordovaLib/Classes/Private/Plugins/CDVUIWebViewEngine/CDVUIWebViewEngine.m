...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(handleViewReload:) name:@"LanguageChanged" object:nil];
...
-(void)handleViewReload:(NSNotification *)nofi {
     [(UIWebView*)_engineWebView reload];
}
