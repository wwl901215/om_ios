...
- (void)updateLeftMenuFrame {
    CGPoint point = CGPointMake(CGRectGetMinX(_rootViewController.view.frame)/2, _leftViewController.view.center.y);
    if(point.x == 0) {
        point.x = -self.menuWidth/2;
    }
    _leftViewController.view.center = point;
}
