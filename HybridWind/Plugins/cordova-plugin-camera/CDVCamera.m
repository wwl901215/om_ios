...
- (CDVPluginResult*)resultForVideo:(NSDictionary*)info
{
    ...
    NSMutableString *resutPath;
    if ([filePath hasPrefix:@"file"]) {
        resutPath = (NSMutableString *)filePath;
    }else{
        resutPath = (NSMutableString *)[NSString stringWithFormat:@"file://%@", filePath];
    }
    return [CDVPluginResult resultWithStatus:CDVCommandStatus_OK messageAsString:resutPath];
}
