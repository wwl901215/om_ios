cordova.define('cordova/plugin_list', function(require, exports, module) {
  module.exports = [
    ...
    {
      "id": "mobile-plugin-language.SwitchLanguagePlugin",
      "file": "plugins/mobile-plugin-language/www/SwitchLanguagePlugin.js",
      "pluginId": "mobile-plugin-language",
      "clobbers": [
        "window.plugins.SwitchLanguagePlugin"
      ]
    },
    {
      "id": "mobile-plugin-fingerprint.FingerprintPlugin",
      "file": "plugins/mobile-plugin-fingerprint/www/FingerprintPlugin.js",
      "pluginId": "mobile-plugin-fingerprint",
      "clobbers": [
        "window.plugins.FingerprintPlugin"
      ]
    },
    {
    ...
    {
      "id": "mobile-plugin-umeng.Umeng",
      "file": "plugins/mobile-plugin-umeng/www/Umeng.js",
      "pluginId": "mobile-plugin-umeng",
      "clobbers": [
        "cordova.plugins.Umeng"
      ]
    },
    {
    ...
    {
      "id": "mobile-plugin-buz.LoginAndOrg",
      "file": "plugins/mobile-plugin-buz/www/LoginAndOrg.js",
      "pluginId": "mobile-plugin-buz",
      "clobbers": [
        "plugins.buz.LoginAndOrg"
      ]
    },
    {
  ...
  module.exports.metadata = {
    ...
    "mobile-plugin-language": "0.0.8",
    "mobile-plugin-fingerprint": "0.0.15",
    ...
    "mobile-plugin-umeng": "0.0.1",
    "cordova-plugin-keyboard": "1.2.0",
    "mobile-plugin-shared-data": "0.1.0",
    "mobile-plugin-web-container": "0.0.41",
    "mobile-plugin-hybrid-lib": "0.1.0",
    "mobile-plugin-buz": "0.1.0",
    "mobile-plugin-shellrouter": "0.1.0",
